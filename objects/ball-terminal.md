...
**Hits** — The aperture below it: grow the ball and the opening narrows. Also the face's period identity, since squaring this off makes Clarendon read a century younger.

**Does not hit** — The counter. The counter is enclosed by the bowl and the stem; the ball terminal never touches it. See [counter](counter.md).
