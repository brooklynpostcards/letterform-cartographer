...
status: live-derived
anchor: [78, 222]
region: {shape: circle, cx: 78, cy: 222, r: 58}
---

# Aperture

**What it is** — The opening on the left, between the underside of the ball terminal and the outer edge of the bowl. The gap where the letter breathes.
...
**Does not hit** — The counter. Closing the aperture does not shrink the counter; they are separate white shapes with separate borders. This is the same collision described from the other side in [counter](counter.md).
